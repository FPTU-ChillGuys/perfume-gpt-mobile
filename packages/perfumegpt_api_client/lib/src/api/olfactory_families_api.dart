...
class OlfactoryFamiliesApi {
  ...
  apiOlfactoryfamiliesGet({
    ...
    return Response<BaseResponseOfListOfOlfactoryFamilyResponse>(
      data: _responseData,
  ...
  apiOlfactoryfamiliesIdGet({
    ...
    return Response<BaseResponseOfOlfactoryFamilyResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  apiOlfactoryfamiliesLookupGet({
    ...
    return Response<BaseResponseOfListOfOlfactoryLookupResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
