...
class InventoryApi {
  ...
  Future<Response<BaseResponseOfBatchDetailResponse>>
  apiInventoryBatchesBatchIdGet({
    ...
    final _path = r'/api/inventory/batches/{batchId}'.replaceAll(
      '{'
      r'batchId'
      '}',
      batchId.toString(),
    ...
    return Response<BaseResponseOfBatchDetailResponse>(
      data: _responseData,
  ...
  apiInventoryBatchesGet({
    ...
    final _path = r'/api/inventory/batches';
    final _options = Options(
      method: r'GET',
      headers: <String, dynamic>{...?headers},
      extra: <String, dynamic>{
    ...
    return Response<BaseResponseOfPagedResultOfBatchDetailResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  apiInventoryBatchesVariantVariantIdGet({
    ...
    final _path = r'/api/inventory/batches/variant/{variantId}'.replaceAll(
      '{'
      r'variantId'
      '}',
      variantId.toString(),
    ...
    return Response<BaseResponseOfListOfBatchDetailResponse>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
