...
import 'package:perfumegpt_api_client/src/model/admin_instruction_controller_create_instruction200_response.dart';
import 'package:perfumegpt_api_client/src/model/admin_instruction_controller_get_all_instructions200_response.dart';
import 'package:perfumegpt_api_client/src/model/create_admin_instruction_request.dart';
import 'package:perfumegpt_api_client/src/model/email_controller_send_email200_response.dart';
import 'package:perfumegpt_api_client/src/model/survey_controller_delete_survey_question200_response.dart';
import 'package:perfumegpt_api_client/src/model/update_admin_instruction_request.dart';
...
_responseData = rawData == null ? null : deserialize<AdminInstructionControllerCreateInstruction200Response, AdminInstructionControllerCreateInstruction200Response>(rawData, 'AdminInstructionControllerCreateInstruction200Response', growable: true);
    ...
    return Response<AdminInstructionControllerCreateInstruction200Response>(
      data: _responseData,
...
_responseData = rawData == null ? null : deserialize<AdminInstructionControllerGetAllInstructions200Response, AdminInstructionControllerGetAllInstructions200Response>(rawData, 'AdminInstructionControllerGetAllInstructions200Response', growable: true);
    ...
    return Response<AdminInstructionControllerGetAllInstructions200Response>(
      data: _responseData,
      headers: _response.headers,
      isRedirect: _response.isRedirect,
      requestOptions: _response.requestOptions,
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<EmailControllerSendEmail200Response>> adminInstructionControllerGetCombinedPromptByType({ 
