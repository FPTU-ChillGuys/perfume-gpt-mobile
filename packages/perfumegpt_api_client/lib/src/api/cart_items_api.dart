...
_responseData = rawData == null ? null : deserialize<BaseResponseOfstring, BaseResponseOfstring>(rawData, 'BaseResponseOfstring', growable: true);
  ...
  Future<Response<BaseResponseOfstring>> apiCartItemsIdRemoveFromCartDelete({ 
    ...
    final _path = r'/api/cart/items/{id}/remove-from-cart'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'DELETE',
      headers: <String, dynamic>{
        ...?headers,
...
_responseData = rawData == null ? null : deserialize<BaseResponseOfstring, BaseResponseOfstring>(rawData, 'BaseResponseOfstring', growable: true);
  ...
  Future<Response<BaseResponseOfstring>> apiCartItemsIdUpdateCartItemPut({ 
    ...
    final _path = r'/api/cart/items/{id}/update-cart-item'.replaceAll('{' r'id' '}', id.toString());
    final _options = Options(
      method: r'PUT',
      headers: <String, dynamic>{
        ...?headers,
