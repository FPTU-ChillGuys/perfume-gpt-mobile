...
class BaseResponseOfPagedResultOfOrderListItem {
  ...
  bool operator ==(Object other) =>
      ...
      other is BaseResponseOfPagedResultOfOrderListItem &&
  ...
  factory BaseResponseOfPagedResultOfOrderListItem.fromJson(
    Map<String, dynamic> json,
  ) => _$BaseResponseOfPagedResultOfOrderListItemFromJson(json);

  Map<String, dynamic> toJson() =>
      _$BaseResponseOfPagedResultOfOrderListItemToJson(this);
