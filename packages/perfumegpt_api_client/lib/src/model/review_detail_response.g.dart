...
abstract class _$ReviewDetailResponseCWProxy {
  ReviewDetailResponse id(String? id);
  ...
  ReviewDetailResponse orderId(String? orderId);

  ReviewDetailResponse quantity(int? quantity);

  ReviewDetailResponse unitPrice(num? unitPrice);
...
Map<String, dynamic> _$ReviewDetailResponseToJson(
  ReviewDetailResponse instance,
) => <String, dynamic>{
  'id': ?instance.id,
