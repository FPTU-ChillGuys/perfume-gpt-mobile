...
abstract class _$CreateBannerRequestCWProxy {
  CreateBannerRequest title(String title);

  CreateBannerRequest temporaryImageId(String temporaryImageId);

  CreateBannerRequest temporaryMobileImageId(String? temporaryMobileImageId);

  CreateBannerRequest altText(String? altText);

  CreateBannerRequest position(BannerPosition position);

  CreateBannerRequest displayOrder(int? displayOrder);

  CreateBannerRequest isActive(bool? isActive);

  CreateBannerRequest startDate(DateTime? startDate);

  CreateBannerRequest endDate(DateTime? endDate);

  CreateBannerRequest linkType(BannerLinkType linkType);

  CreateBannerRequest linkTarget(String linkTarget);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `CreateBannerRequest(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
  /// CreateBannerRequest(...).copyWith(id: 12, name: "My name")
  /// ```
  CreateBannerRequest call({
    String title,
...
/// Use as `instanceOfCreateBannerRequest.copyWith(...)` or call `instanceOfCreateBannerRequest.copyWith.fieldName(value)` for a single field.
class _$CreateBannerRequestCWProxyImpl implements _$CreateBannerRequestCWProxy {
  const _$CreateBannerRequestCWProxyImpl(this._value);

  final CreateBannerRequest _value;

  @override
  CreateBannerRequest title(String title) => call(title: title);
  ...
  @override
  CreateBannerRequest altText(String? altText) => call(altText: altText);
  ...
  @override
  CreateBannerRequest isActive(bool? isActive) => call(isActive: isActive);
  ...
  @override
  CreateBannerRequest endDate(DateTime? endDate) => call(endDate: endDate);
  ...
  CreateBannerRequest call({
    ...
    return CreateBannerRequest(
      title: title == const $CopyWithPlaceholder() || title == null
          ...
          : title as String,
      temporaryImageId:
          temporaryImageId == const $CopyWithPlaceholder() ||
...
extension $CreateBannerRequestCopyWith on CreateBannerRequest {
  /// Returns a callable class used to build a new instance with modified fields.
  /// Example: `instanceOfCreateBannerRequest.copyWith(...)` or `instanceOfCreateBannerRequest.copyWith.fieldName(...)`.
  // ignore: library_private_types_in_public_api
  _$CreateBannerRequestCWProxy get copyWith =>
      _$CreateBannerRequestCWProxyImpl(this);
}
...
CreateBannerRequest _$CreateBannerRequestFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('CreateBannerRequest', json, ($checkedConvert) {
  $checkKeys(
    json,
    requiredKeys: const [
      'title',
