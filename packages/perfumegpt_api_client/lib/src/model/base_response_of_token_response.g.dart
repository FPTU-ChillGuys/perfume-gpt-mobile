...
abstract class _$BaseResponseOfTokenResponseCWProxy {
  ...
  /// This function **does support** nullification of nullable fields. All `null` values passed to `non-nullable` fields will be ignored. You can also use `BaseResponseOfTokenResponse(...).copyWith.fieldName(...)` to override fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfBaseResponseOfTokenResponse.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfBaseResponseOfTokenResponse.copyWith.fieldName(...)`
class _$BaseResponseOfTokenResponseCWProxyImpl
  ...
  @override
  BaseResponseOfTokenResponse success(bool? success) => this(success: success);
...
extension $BaseResponseOfTokenResponseCopyWith on BaseResponseOfTokenResponse {
  /// Returns a callable class that can be used as follows: `instanceOfBaseResponseOfTokenResponse.copyWith(...)` or like so:`instanceOfBaseResponseOfTokenResponse.copyWith.fieldName(...)`.
