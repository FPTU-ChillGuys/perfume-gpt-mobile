...
class PagedResultOfCampaignResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfCampaignResponse &&
          other.items == items &&
  ...
  factory PagedResultOfCampaignResponse.fromJson(Map<String, dynamic> json) =>
      _$PagedResultOfCampaignResponseFromJson(json);
