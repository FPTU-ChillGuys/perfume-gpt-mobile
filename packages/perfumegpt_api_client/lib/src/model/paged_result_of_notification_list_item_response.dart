...
class PagedResultOfNotificationListItemResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfNotificationListItemResponse &&
          other.items == items &&
  ...
  factory PagedResultOfNotificationListItemResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfNotificationListItemResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfNotificationListItemResponseToJson(this);
