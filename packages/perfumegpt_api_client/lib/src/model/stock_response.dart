...
class StockResponse {
  ...
  @JsonKey(name: r'variantImageUrl', required: true, includeIfNull: false)
  final String variantImageUrl;

  @JsonKey(name: r'replenishmentPolicy', required: true, includeIfNull: false)
  final ReplenishmentPolicy replenishmentPolicy;

  @JsonKey(name: r'variantStatus', required: true, includeIfNull: false)
