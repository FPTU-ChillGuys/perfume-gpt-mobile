...
class PagedResultOfInventoryLedgerItemResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfInventoryLedgerItemResponse &&
          other.items == items &&
  ...
  factory PagedResultOfInventoryLedgerItemResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfInventoryLedgerItemResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfInventoryLedgerItemResponseToJson(this);
