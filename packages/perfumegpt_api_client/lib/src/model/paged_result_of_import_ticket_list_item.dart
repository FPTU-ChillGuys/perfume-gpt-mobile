...
class PagedResultOfImportTicketListItem {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfImportTicketListItem &&
          other.items == items &&
  ...
  factory PagedResultOfImportTicketListItem.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfImportTicketListItemFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfImportTicketListItemToJson(this);
