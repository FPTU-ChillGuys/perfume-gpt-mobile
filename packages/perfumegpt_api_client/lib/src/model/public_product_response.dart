...
class PublicProductResponse {
  ...
  final List<PublicProductVariantResponse> variants;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PublicProductResponse &&
      other.id == id &&
      other.name == name &&
      other.gender == gender &&
      other.origin == origin &&
  ...
  factory PublicProductResponse.fromJson(Map<String, dynamic> json) => _$PublicProductResponseFromJson(json);
