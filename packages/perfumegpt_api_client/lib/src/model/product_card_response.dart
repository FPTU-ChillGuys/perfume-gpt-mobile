...
import 'package:perfumegpt_api_client/src/model/product_card_variant_response.dart';
...
class ProductCardResponse {
  ...
  final String? aiAcceptanceId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ProductCardResponse &&
      other.id == id &&
      other.name == name &&
  ...
  factory ProductCardResponse.fromJson(Map<String, dynamic> json) => _$ProductCardResponseFromJson(json);
