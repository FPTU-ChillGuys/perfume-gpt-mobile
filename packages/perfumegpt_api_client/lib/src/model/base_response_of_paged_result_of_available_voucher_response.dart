...
class BaseResponseOfPagedResultOfAvailableVoucherResponse {
  ...
  final ResponseErrorType? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfPagedResultOfAvailableVoucherResponse &&
  ...
  factory BaseResponseOfPagedResultOfAvailableVoucherResponse.fromJson(Map<String, dynamic> json) => _$BaseResponseOfPagedResultOfAvailableVoucherResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfPagedResultOfAvailableVoucherResponseToJson(this);
