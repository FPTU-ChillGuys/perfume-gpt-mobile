...
class DailyRevenueItem {
  ...
  final num? netRevenue;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is DailyRevenueItem &&
      other.date == date &&
  ...
  factory DailyRevenueItem.fromJson(Map<String, dynamic> json) => _$DailyRevenueItemFromJson(json);
