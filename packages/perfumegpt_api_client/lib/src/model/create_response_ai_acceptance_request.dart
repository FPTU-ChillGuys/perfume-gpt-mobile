...
class CreateResponseAIAcceptanceRequest {
  ...
  CreateResponseAIAcceptanceRequest({
    ...
    required  this.contextType,
     ...
     this.metadata,
      ...
      /// ID người dùng (optional trong trường hợp nguồn không có user cụ thể)
  @JsonKey(
  ...
  final Object? metadata;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateResponseAIAcceptanceRequest &&
      other.userId == userId &&
  ...
  factory CreateResponseAIAcceptanceRequest.fromJson(Map<String, dynamic> json) => _$CreateResponseAIAcceptanceRequestFromJson(json);

  Map<String, dynamic> toJson() => _$CreateResponseAIAcceptanceRequestToJson(this);
