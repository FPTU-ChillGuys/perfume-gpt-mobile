...
class UpdateReturnRequestDto {
  ...
  final List<String>? removeMediaIds;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is UpdateReturnRequestDto &&
  ...
  factory UpdateReturnRequestDto.fromJson(Map<String, dynamic> json) => _$UpdateReturnRequestDtoFromJson(json);
