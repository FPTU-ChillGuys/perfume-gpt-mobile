...
class BaseResponseOfAddressLevel4Response {
  ...
  final int? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfAddressLevel4Response &&
  ...
  factory BaseResponseOfAddressLevel4Response.fromJson(Map<String, dynamic> json) => _$BaseResponseOfAddressLevel4ResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfAddressLevel4ResponseToJson(this);
