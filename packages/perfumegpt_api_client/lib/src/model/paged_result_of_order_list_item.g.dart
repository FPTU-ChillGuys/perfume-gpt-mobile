...
class _$PagedResultOfOrderListItemCWProxyImpl
  ...
  final PagedResultOfOrderListItem _value;
...
PagedResultOfOrderListItem _$PagedResultOfOrderListItemFromJson(
  Map<String, dynamic> json,
) => $checkedCreate('PagedResultOfOrderListItem', json, ($checkedConvert) {
  $checkKeys(
    json,
    requiredKeys: const ['items', 'pageNumber', 'pageSize', 'totalCount'],
  );
  final val = PagedResultOfOrderListItem(
...
Map<String, dynamic> _$PagedResultOfOrderListItemToJson(
  PagedResultOfOrderListItem instance,
) => <String, dynamic>{
