...
class CalculateFeeData {
  ...
  @JsonKey(name: r'service_fee', required: false, includeIfNull: false)
  final int? serviceFee;

  @JsonKey(name: r'insurance_fee', required: false, includeIfNull: false)
  final int? insuranceFee;

  @JsonKey(name: r'pick_station_fee', required: false, includeIfNull: false)
  final int? pickStationFee;

  @JsonKey(name: r'coupon_value', required: false, includeIfNull: false)
  final int? couponValue;

  @JsonKey(name: r'r2s_fee', required: false, includeIfNull: false)
  final int? r2sFee;

  @JsonKey(name: r'document_return', required: false, includeIfNull: false)
  final int? documentReturn;

  @JsonKey(name: r'double_check', required: false, includeIfNull: false)
  final int? doubleCheck;

  @JsonKey(name: r'cod_fee', required: false, includeIfNull: false)
  final int? codFee;
  ...
  @JsonKey(name: r'cod_failed_fee', required: false, includeIfNull: false)
  final int? codFailedFee;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is CalculateFeeData &&
          other.total == total &&
  ...
  factory CalculateFeeData.fromJson(Map<String, dynamic> json) =>
      _$CalculateFeeDataFromJson(json);
