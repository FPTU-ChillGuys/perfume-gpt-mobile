...
class LoyaltyTransactionTotalsResponse {
  ...
  final int? totalTransactions;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is LoyaltyTransactionTotalsResponse &&
      other.userId == userId &&
  ...
  factory LoyaltyTransactionTotalsResponse.fromJson(Map<String, dynamic> json) => _$LoyaltyTransactionTotalsResponseFromJson(json);

  Map<String, dynamic> toJson() => _$LoyaltyTransactionTotalsResponseToJson(this);
