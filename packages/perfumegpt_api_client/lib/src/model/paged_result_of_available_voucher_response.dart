...
class PagedResultOfAvailableVoucherResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfAvailableVoucherResponse &&
          other.items == items &&
  ...
  factory PagedResultOfAvailableVoucherResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfAvailableVoucherResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfAvailableVoucherResponseToJson(this);
