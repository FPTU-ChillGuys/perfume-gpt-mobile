...
class PagedResultOfBatchDetailResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfBatchDetailResponse &&
          other.items == items &&
  ...
  factory PagedResultOfBatchDetailResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfBatchDetailResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfBatchDetailResponseToJson(this);
