...
abstract class _$VariantPagedItemCWProxy {
  VariantPagedItem id(String? id);
...
Map<String, dynamic> _$VariantPagedItemToJson(VariantPagedItem instance) =>
    <String, dynamic>{
      'id': ?instance.id,
