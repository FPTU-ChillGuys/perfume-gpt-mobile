...
class BaseResponseOfGetCartTotalResponse {
  ...
  final int? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfGetCartTotalResponse &&
  ...
  factory BaseResponseOfGetCartTotalResponse.fromJson(Map<String, dynamic> json) => _$BaseResponseOfGetCartTotalResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfGetCartTotalResponseToJson(this);
