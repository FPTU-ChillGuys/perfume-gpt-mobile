...
class ProcessInStoreReturnFastTrackDto {
  ...
  final List<String>? temporaryMediaIds;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ProcessInStoreReturnFastTrackDto &&
  ...
  factory ProcessInStoreReturnFastTrackDto.fromJson(Map<String, dynamic> json) => _$ProcessInStoreReturnFastTrackDtoFromJson(json);

  Map<String, dynamic> toJson() => _$ProcessInStoreReturnFastTrackDtoToJson(this);
