...
abstract class _$AIAcceptanceCWProxy {
  ...
  AIAcceptance userId(Object userId);

  AIAcceptance cartItemId(Object? cartItemId);
...
class _$AIAcceptanceCWProxyImpl implements _$AIAcceptanceCWProxy {
  ...
  @override
  AIAcceptance userId(Object userId) => call(userId: userId);

  @override
  AIAcceptance cartItemId(Object? cartItemId) => call(cartItemId: cartItemId);
...
AIAcceptance _$AIAcceptanceFromJson(
  ...
  final val = AIAcceptance(
    ...
    userId: $checkedConvert('userId', (v) => v as Object),
    cartItemId: $checkedConvert('cartItemId', (v) => v),
