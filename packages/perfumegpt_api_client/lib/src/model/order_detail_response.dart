...
class OrderDetailResponse {
  ...
  @JsonKey(name: r'campaignDiscount', required: false, includeIfNull: false)
  final num? campaignDiscount;

  @JsonKey(name: r'campaignPrice', required: false, includeIfNull: false)
  final num? campaignPrice;

  @JsonKey(name: r'voucherDiscount', required: false, includeIfNull: false)
  final num? voucherDiscount;

  @JsonKey(name: r'itemTotal', required: false, includeIfNull: false)
  final num? itemTotal;
