...
class PagedResultOfCashFlowLedgerItemResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfCashFlowLedgerItemResponse &&
          other.items == items &&
  ...
  factory PagedResultOfCashFlowLedgerItemResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfCashFlowLedgerItemResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfCashFlowLedgerItemResponseToJson(this);
