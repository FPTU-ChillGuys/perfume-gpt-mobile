...
class CreateStockAdjustmentDetailRequest {
  ...
  @JsonKey(name: r'batchId', required: true, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is CreateStockAdjustmentDetailRequest &&
  ...
  factory CreateStockAdjustmentDetailRequest.fromJson(
    Map<String, dynamic> json,
  ) => _$CreateStockAdjustmentDetailRequestFromJson(json);

  Map<String, dynamic> toJson() =>
      _$CreateStockAdjustmentDetailRequestToJson(this);
