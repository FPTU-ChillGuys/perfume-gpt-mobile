...
class InventoryLedgerItemResponse {
  ...
  final String? actorId;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is InventoryLedgerItemResponse &&
      other.id == id &&
  ...
  factory InventoryLedgerItemResponse.fromJson(Map<String, dynamic> json) => _$InventoryLedgerItemResponseFromJson(json);
