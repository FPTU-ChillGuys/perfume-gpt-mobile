...
class UpdateBannerRequest {
  /// Returns a new [UpdateBannerRequest] instance.
  UpdateBannerRequest({
    required this.title,

    this.temporaryImageId,
  ...
  @JsonKey(name: r'temporaryImageId', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'linkType', required: true, includeIfNull: false)
  final BannerLinkType linkType;

  @JsonKey(name: r'linkTarget', required: true, includeIfNull: false)
  final String linkTarget;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UpdateBannerRequest &&
          other.title == title &&
  ...
  int get hashCode =>
      title.hashCode +
      (temporaryImageId == null ? 0 : temporaryImageId.hashCode) +
  ...
  Map<String, dynamic> toJson() => _$UpdateBannerRequestToJson(this);
