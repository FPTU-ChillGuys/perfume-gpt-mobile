...
class BaseResponseOfConcentrationResponse {
  ...
  final ResponseErrorType? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfConcentrationResponse &&
  ...
  factory BaseResponseOfConcentrationResponse.fromJson(Map<String, dynamic> json) => _$BaseResponseOfConcentrationResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfConcentrationResponseToJson(this);
