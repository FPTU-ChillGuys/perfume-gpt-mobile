...
class PaymentTransactionAdminItemResponse {
  ...
  @JsonKey(name: r'transactionStatus', required: false, includeIfNull: false)
  final TransactionStatus? transactionStatus;

  @JsonKey(name: r'amount', required: false, includeIfNull: false)
  final num? amount;

  @JsonKey(name: r'gatewayTransactionNo', required: false, includeIfNull: false)
  final String? gatewayTransactionNo;

  @JsonKey(name: r'failureReason', required: false, includeIfNull: false)
  final String? failureReason;

  @JsonKey(name: r'originalPaymentId', required: false, includeIfNull: false)
  final String? originalPaymentId;

  @JsonKey(name: r'retryAttempt', required: false, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is PaymentTransactionAdminItemResponse &&
          other.id == id &&
  ...
  factory PaymentTransactionAdminItemResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PaymentTransactionAdminItemResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaymentTransactionAdminItemResponseToJson(this);
