...
class ImportTicketResponse {
  ...
  @JsonKey(name: r'supplierName', required: false, includeIfNull: false)
  ...
  factory ImportTicketResponse.fromJson(Map<String, dynamic> json) =>
      _$ImportTicketResponseFromJson(json);
