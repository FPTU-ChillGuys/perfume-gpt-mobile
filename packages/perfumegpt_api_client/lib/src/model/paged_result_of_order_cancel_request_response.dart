...
class PagedResultOfOrderCancelRequestResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfOrderCancelRequestResponse &&
          other.items == items &&
  ...
  factory PagedResultOfOrderCancelRequestResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfOrderCancelRequestResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfOrderCancelRequestResponseToJson(this);
