...
class BaseResponseOfPagedResultOfOrderCancelRequestResponse {
  ...
  final ResponseErrorType? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfPagedResultOfOrderCancelRequestResponse &&
  ...
  factory BaseResponseOfPagedResultOfOrderCancelRequestResponse.fromJson(Map<String, dynamic> json) => _$BaseResponseOfPagedResultOfOrderCancelRequestResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfPagedResultOfOrderCancelRequestResponseToJson(this);
