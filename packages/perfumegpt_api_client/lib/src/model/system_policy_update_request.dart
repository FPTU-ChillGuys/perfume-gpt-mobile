...
class SystemPolicyUpdateRequest {
  ...
  SystemPolicyUpdateRequest({required this.title, required this.htmlContent});
  ...
  bool operator ==(Object other) =>
      ...
      other is SystemPolicyUpdateRequest &&
          other.title == title &&
  ...
  factory SystemPolicyUpdateRequest.fromJson(Map<String, dynamic> json) =>
      _$SystemPolicyUpdateRequestFromJson(json);
