...
class BaseResponseOfPagedResultOfLoyaltyTransactionHistoryItemResponse {
  ...
  final ResponseErrorType? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfPagedResultOfLoyaltyTransactionHistoryItemResponse &&
  ...
  factory BaseResponseOfPagedResultOfLoyaltyTransactionHistoryItemResponse.fromJson(Map<String, dynamic> json) => _$BaseResponseOfPagedResultOfLoyaltyTransactionHistoryItemResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfPagedResultOfLoyaltyTransactionHistoryItemResponseToJson(this);
