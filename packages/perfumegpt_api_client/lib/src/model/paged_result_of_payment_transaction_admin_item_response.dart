...
class PagedResultOfPaymentTransactionAdminItemResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is PagedResultOfPaymentTransactionAdminItemResponse &&
          other.items == items &&
  ...
  factory PagedResultOfPaymentTransactionAdminItemResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PagedResultOfPaymentTransactionAdminItemResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PagedResultOfPaymentTransactionAdminItemResponseToJson(this);
