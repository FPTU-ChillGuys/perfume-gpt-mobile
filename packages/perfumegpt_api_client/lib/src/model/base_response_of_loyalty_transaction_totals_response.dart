...
class BaseResponseOfLoyaltyTransactionTotalsResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is BaseResponseOfLoyaltyTransactionTotalsResponse &&
  ...
  factory BaseResponseOfLoyaltyTransactionTotalsResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$BaseResponseOfLoyaltyTransactionTotalsResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$BaseResponseOfLoyaltyTransactionTotalsResponseToJson(this);
