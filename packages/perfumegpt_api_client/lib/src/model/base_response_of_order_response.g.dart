...
abstract class _$BaseResponseOfOrderResponseCWProxy {
  ...
  /// This function **does support** nullification of nullable fields. All `null` values passed to `non-nullable` fields will be ignored. You can also use `BaseResponseOfOrderResponse(...).copyWith.fieldName(...)` to override fields one at a time with nullification support.
  ///
  /// Usage
  /// ```dart
...
/// Proxy class for `copyWith` functionality. This is a callable class and can be used as follows: `instanceOfBaseResponseOfOrderResponse.copyWith(...)`. Additionally contains functions for specific fields e.g. `instanceOfBaseResponseOfOrderResponse.copyWith.fieldName(...)`
class _$BaseResponseOfOrderResponseCWProxyImpl
  ...
  @override
  BaseResponseOfOrderResponse success(bool? success) => this(success: success);
...
extension $BaseResponseOfOrderResponseCopyWith on BaseResponseOfOrderResponse {
  /// Returns a callable class that can be used as follows: `instanceOfBaseResponseOfOrderResponse.copyWith(...)` or like so:`instanceOfBaseResponseOfOrderResponse.copyWith.fieldName(...)`.
