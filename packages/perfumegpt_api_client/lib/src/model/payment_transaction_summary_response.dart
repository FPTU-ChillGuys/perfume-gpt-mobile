...
class PaymentTransactionSummaryResponse {
  ...
  @JsonKey(name: r'totalPaymentAmount', required: false, includeIfNull: false)
  ...
  @JsonKey(name: r'totalRefundAmount', required: false, includeIfNull: false)
  final num? totalRefundAmount;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is PaymentTransactionSummaryResponse &&
          ...
          other.totalShippingFeeDeductedPerOrder ==
              totalShippingFeeDeductedPerOrder &&
          other.totalPaymentAmountExcludingShipping ==
  ...
  factory PaymentTransactionSummaryResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$PaymentTransactionSummaryResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$PaymentTransactionSummaryResponseToJson(this);
