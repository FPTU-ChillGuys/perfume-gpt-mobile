...
class UserManageItem {
  ...
  @JsonKey(name: r'profileImageUrl', required: false, includeIfNull: false)
  final String? profileImageUrl;

  @JsonKey(name: r'deliveryRefusalCount', required: false, includeIfNull: false)
  final int? deliveryRefusalCount;

  @JsonKey(name: r'codBlockedUntil', required: false, includeIfNull: false)
  final DateTime? codBlockedUntil;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is UserManageItem &&
          other.id == id &&
  ...
  factory UserManageItem.fromJson(Map<String, dynamic> json) =>
      _$UserManageItemFromJson(json);
