...
import 'package:perfumegpt_api_client/src/model/base_response_of_list_of_batch_detail_response.dart';
...
import 'package:perfumegpt_api_client/src/model/base_response_of_loyalty_point_response.dart';
...
import 'package:perfumegpt_api_client/src/model/calculate_fee_response.dart';
...
import 'package:perfumegpt_api_client/src/model/loyalty_point_response.dart';
...
import 'package:perfumegpt_api_client/src/model/update_review_request.dart';
  ...
  switch (targetType) {
    ...
    case 'BaseResponseOfBulkActionResultOfstring':
      return BaseResponseOfBulkActionResultOfstring.fromJson(
          ...
          as ReturnType;
    case 'BaseResponseOfCalculateFeeResponse':
      return BaseResponseOfCalculateFeeResponse.fromJson(
            value as Map<String, dynamic>,
          )
          as ReturnType;
    ...
    case 'BaseResponseOfListOfAttributeValueLookupItem':
      return BaseResponseOfListOfAttributeValueLookupItem.fromJson(
          ...
          as ReturnType;
    case 'BaseResponseOfListOfBatchDetailResponse':
      return BaseResponseOfListOfBatchDetailResponse.fromJson(
            value as Map<String, dynamic>,
          )
          as ReturnType;
    ...
    case 'BaseResponseOfListOfWardResponse':
      return BaseResponseOfListOfWardResponse.fromJson(
          ...
          as ReturnType;
    case 'BaseResponseOfLoyaltyPointResponse':
      return BaseResponseOfLoyaltyPointResponse.fromJson(
            value as Map<String, dynamic>,
          )
          as ReturnType;
    ...
    case 'BaseResponseOfPreviewOrderResponse':
      return BaseResponseOfPreviewOrderResponse.fromJson(
            value as Map<String, dynamic>,
          )
          as ReturnType;
    ...
    case 'BulkOperationResult':
      return BulkOperationResult.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'CalculateFeeData':
      return CalculateFeeData.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'CalculateFeeRequest':
      return CalculateFeeRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'CalculateFeeResponse':
      return CalculateFeeResponse.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'CarrierName':
    ...
    case 'CreateOrderDetailRequest':
      return CreateOrderDetailRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    ...
    case 'LoyaltyPointResponse':
      return LoyaltyPointResponse.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'MediaResponse':
      return MediaResponse.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'OrderDetailListItems':
      return OrderDetailListItems.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    ...
    case 'PickListResponse':
      return PickListResponse.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'PointsRequest':
      return PointsRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'PreviewOrderResponse':
      return PreviewOrderResponse.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    case 'ProblemDetails':
    ...
    case 'RecipientInformation':
      return RecipientInformation.fromJson(value as Map<String, dynamic>)
          as ReturnType;
    ...
    case 'UpdateOrderStatusRequest':
      return UpdateOrderStatusRequest.fromJson(value as Map<String, dynamic>)
          as ReturnType;
