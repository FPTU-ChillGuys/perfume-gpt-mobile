...
// tests for GetCartItemResponse
void main() {
  final GetCartItemResponse? instance = /* GetCartItemResponse(...) */ null;
  // TODO add properties to the entity

  group(GetCartItemResponse, () {
    // String cartItemId
    ...
    // num variantPrice
    test('to test the property `variantPrice`', () async {
      // TODO
    });
