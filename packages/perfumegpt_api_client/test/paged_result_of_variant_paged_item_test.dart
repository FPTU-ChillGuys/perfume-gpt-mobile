...
// tests for PagedResultOfVariantPagedItem
void main() {
  final PagedResultOfVariantPagedItem? instance = /* PagedResultOfVariantPagedItem(...) */ null;
  // TODO add properties to the entity

  group(PagedResultOfVariantPagedItem, () {
