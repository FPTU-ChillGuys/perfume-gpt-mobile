...
void main() {
  ...
  group(OrderReturnRequestResponse, () {
    ...
    test('to test the property `processedById`', () async {
      // TODO
    });

    // String processedByName
    test('to test the property `processedByName`', () async {
      // TODO
    });

    // String inspectedById
    test('to test the property `inspectedById`', () async {
      // TODO
    });

    // String inspectedByName
    test('to test the property `inspectedByName`', () async {
      // TODO
    });
    ...
    // bool isRefunded
    test('to test the property `isRefunded`', () async {
      // TODO
    });
    ...
    test('to test the property `returnShippingInfo`', () async {
      // TODO
    });
