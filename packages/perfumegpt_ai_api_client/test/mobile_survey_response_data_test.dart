...
// tests for MobileSurveyResponseData
void main() {
  final MobileSurveyResponseData? instance = /* MobileSurveyResponseData(...) */
      null;
  // TODO add properties to the entity

  group(MobileSurveyResponseData, () {
