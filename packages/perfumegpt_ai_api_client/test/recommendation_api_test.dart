...
void main() {
  ...
  group(RecommendationApi, () {
    ...
    //
    //Future<SurveyControllerReorderQuestions200Response> recommendationControllerGetRecommendationsV3Simple(String userId, { num size }) async
    ...
    //
    //Future<SurveyControllerCreateSurveyQues200Response> recommendationControllerTestRecommendation(String userId) async
    ...
    //
    //Future<SurveyControllerCreateSurveyQues200Response> recommendationControllerTestRepurchase(String userId, String orderId) async
