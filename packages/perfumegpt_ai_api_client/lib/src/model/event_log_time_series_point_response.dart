...
class EventLogTimeSeriesPointResponse {
  ...
  @JsonKey(name: r'bucketStart', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'messageCount', required: true, includeIfNull: false)
  final num messageCount;

  /// Số event search trong bucket
  @JsonKey(name: r'searchCount', required: true, includeIfNull: false)
  final num searchCount;

  /// Số event survey trong bucket
  @JsonKey(name: r'surveyCount', required: true, includeIfNull: false)
  final num surveyCount;

  /// Số event product trong bucket
  @JsonKey(name: r'productCount', required: true, includeIfNull: false)
  final num productCount;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is EventLogTimeSeriesPointResponse &&
  ...
  factory EventLogTimeSeriesPointResponse.fromJson(Map<String, dynamic> json) =>
      _$EventLogTimeSeriesPointResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$EventLogTimeSeriesPointResponseToJson(this);
