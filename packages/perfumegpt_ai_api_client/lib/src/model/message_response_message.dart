...
class MessageResponseMessage {
  ...
  final List<String> suggestedQuestions;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MessageResponseMessage &&
  ...
  factory MessageResponseMessage.fromJson(Map<String, dynamic> json) => _$MessageResponseMessageFromJson(json);
