...
class MobileSurveyProduct {
  ...
  final num maxPrice;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MobileSurveyProduct &&
      other.id == id &&
      other.name == name &&
  ...
  factory MobileSurveyProduct.fromJson(Map<String, dynamic> json) => _$MobileSurveyProductFromJson(json);
