...
class OrderListItemResponse {
  ...
  /// Customer ID
  @JsonKey(name: r'customerId', required: true, includeIfNull: true)
  final Object? customerId;

  /// Customer name
  @JsonKey(name: r'customerName', required: true, includeIfNull: true)
  ...
  @JsonKey(name: r'shippingStatus', required: true, includeIfNull: true)
  final Object? shippingStatus;

  /// Staff ID
  @JsonKey(name: r'staffId', required: true, includeIfNull: true)
  final Object? staffId;

  /// Staff name
  @JsonKey(name: r'staffName', required: true, includeIfNull: true)
  ...
  bool operator ==(Object other) =>
      ...
      other is OrderListItemResponse &&
  ...
  factory OrderListItemResponse.fromJson(Map<String, dynamic> json) =>
      _$OrderListItemResponseFromJson(json);
