...
class MobileSurveyRequest {
  ...
  final List<MobileSurveyAnswer> answers;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MobileSurveyRequest &&
      other.userId == userId &&
  ...
  factory MobileSurveyRequest.fromJson(Map<String, dynamic> json) => _$MobileSurveyRequestFromJson(json);
