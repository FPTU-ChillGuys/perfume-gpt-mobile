...
abstract class _$BaseResponseOfListOfProvinceResponseCWProxy {
  ...
  BaseResponseOfListOfProvinceResponse errorType(int? errorType);

  /// Creates a new instance with the provided field values.
  /// Passing `null` to a nullable field nullifies it, while `null` for a non-nullable field is ignored. To update a single field use `BaseResponseOfListOfProvinceResponse(...).copyWith.fieldName(value)`.
  ///
  /// Example:
  /// ```dart
...
/// Use as `instanceOfBaseResponseOfListOfProvinceResponse.copyWith(...)` or call `instanceOfBaseResponseOfListOfProvinceResponse.copyWith.fieldName(value)` for a single field.
...
extension $BaseResponseOfListOfProvinceResponseCopyWith
  ...
  /// Example: `instanceOfBaseResponseOfListOfProvinceResponse.copyWith(...)` or `instanceOfBaseResponseOfListOfProvinceResponse.copyWith.fieldName(...)`.
