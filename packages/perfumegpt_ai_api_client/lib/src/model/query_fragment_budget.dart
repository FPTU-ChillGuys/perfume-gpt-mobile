...
class QueryFragmentBudget {
  ...
  final num? max;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is QueryFragmentBudget &&
      other.type == type &&
      other.min == min &&
      other.max == max;
  ...
  factory QueryFragmentBudget.fromJson(Map<String, dynamic> json) => _$QueryFragmentBudgetFromJson(json);
