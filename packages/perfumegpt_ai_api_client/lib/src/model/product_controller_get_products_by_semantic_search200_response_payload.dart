...
class ProductControllerGetProductsBySemanticSearch200ResponsePayload {
  ...
  final num totalPages;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ProductControllerGetProductsBySemanticSearch200ResponsePayload &&
      other.items == items &&
  ...
  factory ProductControllerGetProductsBySemanticSearch200ResponsePayload.fromJson(Map<String, dynamic> json) => _$ProductControllerGetProductsBySemanticSearch200ResponsePayloadFromJson(json);

  Map<String, dynamic> toJson() => _$ProductControllerGetProductsBySemanticSearch200ResponsePayloadToJson(this);
