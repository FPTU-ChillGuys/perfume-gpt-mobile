...
class ProductCardOutputItemDto {
  ...
  final Object? source_;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ProductCardOutputItemDto &&
      other.id == id &&
      other.name == name &&
  ...
  factory ProductCardOutputItemDto.fromJson(Map<String, dynamic> json) => _$ProductCardOutputItemDtoFromJson(json);
