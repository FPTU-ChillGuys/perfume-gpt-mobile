...
class AIAcceptanceResponse {
  ...
  final String status;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is AIAcceptanceResponse &&
      other.id == id &&
  ...
  factory AIAcceptanceResponse.fromJson(Map<String, dynamic> json) => _$AIAcceptanceResponseFromJson(json);
