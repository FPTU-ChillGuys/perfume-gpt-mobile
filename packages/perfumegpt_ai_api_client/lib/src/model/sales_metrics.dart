...
class SalesMetrics {
  ...
  @JsonKey(name: r'last7DaysSales', required: true, includeIfNull: false)
  final num last7DaysSales;

  /// Tổng bán trong 30 ngày gần nhất
  @JsonKey(name: r'last30DaysSales', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'volatility', required: true, includeIfNull: false)
  final SalesMetricsVolatilityEnum volatility;

  /// Dữ liệu bán hàng được encode (TOON format)
  @JsonKey(name: r'encodedData', required: true, includeIfNull: true)
  final String? encodedData;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is SalesMetrics &&
