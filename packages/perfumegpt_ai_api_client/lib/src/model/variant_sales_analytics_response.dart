...
class VariantSalesAnalyticsResponse {
  ...
  /// Tên nồng độ
  @JsonKey(name: r'concentrationName', required: true, includeIfNull: true)
  final Object? concentrationName;

  /// Dữ liệu bán hàng theo ngày
  @JsonKey(name: r'dailySalesData', required: true, includeIfNull: false)
  final List<DailySalesRecord> dailySalesData;

  /// Tổng số lượng bán trong 2 tháng
  @JsonKey(name: r'totalQuantitySold', required: true, includeIfNull: false)
  ...
  @JsonKey(name: r'averageDailySales', required: true, includeIfNull: false)
  final num averageDailySales;

  /// Ngày bắt đầu phân tích
  @JsonKey(name: r'periodStartDate', required: true, includeIfNull: false)
  final String periodStartDate;

  /// Ngày kết thúc phân tích
  @JsonKey(name: r'periodEndDate', required: true, includeIfNull: false)
  final String periodEndDate;

  /// Số ngày có dữ liệu bán hàng
  @JsonKey(name: r'daysWithSalesCount', required: true, includeIfNull: false)
  final num daysWithSalesCount;

  /// Metrics tối ưu cho LLM dự đoán restock
  @JsonKey(name: r'salesMetrics', required: true, includeIfNull: false)
  final SalesMetrics salesMetrics;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is VariantSalesAnalyticsResponse &&
  ...
  factory VariantSalesAnalyticsResponse.fromJson(Map<String, dynamic> json) =>
      _$VariantSalesAnalyticsResponseFromJson(json);
