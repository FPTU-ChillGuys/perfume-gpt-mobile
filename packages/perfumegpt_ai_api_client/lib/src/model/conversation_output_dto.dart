...
class ConversationOutputDto {
  ...
  @JsonKey(name: r'suggestedQuestions', required: true, includeIfNull: true)
  final List<String>? suggestedQuestions;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ConversationOutputDto &&
  ...
  factory ConversationOutputDto.fromJson(Map<String, dynamic> json) =>
      _$ConversationOutputDtoFromJson(json);
