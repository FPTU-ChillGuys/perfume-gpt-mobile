...
class BaseResponseOfBulkActionResultOfGuid {
  ...
  final int? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfBulkActionResultOfGuid &&
  ...
  factory BaseResponseOfBulkActionResultOfGuid.fromJson(Map<String, dynamic> json) => _$BaseResponseOfBulkActionResultOfGuidFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfBulkActionResultOfGuidToJson(this);
