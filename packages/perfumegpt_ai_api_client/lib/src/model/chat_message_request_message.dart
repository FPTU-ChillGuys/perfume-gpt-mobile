...
class ChatMessageRequestMessage {
  ...
  final List<String> suggestedQuestions;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ChatMessageRequestMessage &&
  ...
  factory ChatMessageRequestMessage.fromJson(Map<String, dynamic> json) => _$ChatMessageRequestMessageFromJson(json);
