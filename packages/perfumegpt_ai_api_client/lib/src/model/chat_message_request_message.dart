...
part 'chat_message_request_message.g.dart';
...
class ChatMessageRequestMessage {
  /// Returns a new [ChatMessageRequestMessage] instance.
  ...
  @JsonKey(name: r'suggestedQuestions', required: true, includeIfNull: false)
  final List<String> suggestedQuestions;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is ChatMessageRequestMessage &&
  ...
  factory ChatMessageRequestMessage.fromJson(Map<String, dynamic> json) =>
      _$ChatMessageRequestMessageFromJson(json);

  Map<String, dynamic> toJson() => _$ChatMessageRequestMessageToJson(this);
