...
part 'message_dto_message.g.dart';
...
class MessageDtoMessage {
  /// Returns a new [MessageDtoMessage] instance.
  MessageDtoMessage({
  ...
  final List<String> suggestedQuestions;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is MessageDtoMessage &&
  ...
  factory MessageDtoMessage.fromJson(Map<String, dynamic> json) => _$MessageDtoMessageFromJson(json);

  Map<String, dynamic> toJson() => _$MessageDtoMessageToJson(this);
