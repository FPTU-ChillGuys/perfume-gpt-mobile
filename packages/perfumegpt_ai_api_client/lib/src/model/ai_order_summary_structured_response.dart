...
class AIOrderSummaryStructuredResponse {
  ...
  bool operator ==(Object other) =>
      ...
      other is AIOrderSummaryStructuredResponse &&
  ...
  factory AIOrderSummaryStructuredResponse.fromJson(
    Map<String, dynamic> json,
  ) => _$AIOrderSummaryStructuredResponseFromJson(json);

  Map<String, dynamic> toJson() =>
      _$AIOrderSummaryStructuredResponseToJson(this);
