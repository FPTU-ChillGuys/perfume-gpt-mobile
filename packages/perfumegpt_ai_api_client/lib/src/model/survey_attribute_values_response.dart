...
class SurveyAttributeValuesResponse {
  ...
  final List<String>? subGroups;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is SurveyAttributeValuesResponse &&
      other.type == type &&
      other.label == label &&
      other.values == values &&
  ...
  factory SurveyAttributeValuesResponse.fromJson(Map<String, dynamic> json) => _$SurveyAttributeValuesResponseFromJson(json);
