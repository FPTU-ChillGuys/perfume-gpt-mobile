...
class InventoryStockResponse {
  ...
  @JsonKey(name: r'isLowStock', required: true, includeIfNull: false)
  ...
  bool operator ==(Object other) =>
      ...
      other is InventoryStockResponse &&
  ...
  factory InventoryStockResponse.fromJson(Map<String, dynamic> json) =>
      _$InventoryStockResponseFromJson(json);
