...
class PagedResultOfShippingInfoListItem {
  ...
  final bool? hasNextPage;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is PagedResultOfShippingInfoListItem &&
      other.items == items &&
  ...
  factory PagedResultOfShippingInfoListItem.fromJson(Map<String, dynamic> json) => _$PagedResultOfShippingInfoListItemFromJson(json);

  Map<String, dynamic> toJson() => _$PagedResultOfShippingInfoListItemToJson(this);
