...
class CreateAdminInstructionRequest {
  ...
  /// Loại chỉ thị
  @JsonKey(name: r'instructionType', required: true, includeIfNull: false)
  final CreateAdminInstructionRequestInstructionTypeEnum instructionType;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is CreateAdminInstructionRequest &&
  ...
  factory CreateAdminInstructionRequest.fromJson(Map<String, dynamic> json) =>
      _$CreateAdminInstructionRequestFromJson(json);
