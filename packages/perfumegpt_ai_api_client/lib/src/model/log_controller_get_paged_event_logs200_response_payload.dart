...
class LogControllerGetPagedEventLogs200ResponsePayload {
  ...
  final num totalPages;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is LogControllerGetPagedEventLogs200ResponsePayload &&
      other.items == items &&
  ...
  factory LogControllerGetPagedEventLogs200ResponsePayload.fromJson(Map<String, dynamic> json) => _$LogControllerGetPagedEventLogs200ResponsePayloadFromJson(json);

  Map<String, dynamic> toJson() => _$LogControllerGetPagedEventLogs200ResponsePayloadToJson(this);
