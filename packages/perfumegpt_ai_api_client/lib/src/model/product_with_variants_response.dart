...
class ProductWithVariantsResponse {
  ...
  final Object? updatedAt;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is ProductWithVariantsResponse &&
      other.id == id &&
      other.name == name &&
  ...
  factory ProductWithVariantsResponse.fromJson(Map<String, dynamic> json) => _$ProductWithVariantsResponseFromJson(json);
