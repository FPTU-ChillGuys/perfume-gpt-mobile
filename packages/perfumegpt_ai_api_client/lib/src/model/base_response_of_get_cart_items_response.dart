...
class BaseResponseOfGetCartItemsResponse {
  ...
  final int? errorType;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is BaseResponseOfGetCartItemsResponse &&
  ...
  factory BaseResponseOfGetCartItemsResponse.fromJson(Map<String, dynamic> json) => _$BaseResponseOfGetCartItemsResponseFromJson(json);

  Map<String, dynamic> toJson() => _$BaseResponseOfGetCartItemsResponseToJson(this);
