...
class SurveyAttributeValueItemQueryFragment {
  ...
  bool operator ==(Object other) =>
      ...
      other is SurveyAttributeValueItemQueryFragment &&
          other.type == type &&
          other.match == match &&
  ...
  factory SurveyAttributeValueItemQueryFragment.fromJson(
    Map<String, dynamic> json,
  ) => _$SurveyAttributeValueItemQueryFragmentFromJson(json);

  Map<String, dynamic> toJson() =>
      _$SurveyAttributeValueItemQueryFragmentToJson(this);
