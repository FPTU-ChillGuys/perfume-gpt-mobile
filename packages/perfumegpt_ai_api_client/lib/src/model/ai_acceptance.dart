...
class AIAcceptance {
  ...
  @JsonKey(name: r'responseId', required: true, includeIfNull: true)
  final Object? responseId;

  /// Ngữ cảnh phát sinh acceptance (chatbot/survey/trend/recommendation/repurchase/cart_legacy)
  @JsonKey(name: r'contextType', required: true, includeIfNull: true)
  ...
  @JsonKey(name: r'productIdsJson', required: true, includeIfNull: true)
  final Object? productIdsJson;

  /// Metadata mở rộng dưới dạng JSON string
  @JsonKey(name: r'metadataJson', required: true, includeIfNull: true)
  final Object? metadataJson;

  /// Thời điểm false no-click được phép hiển thị
  @JsonKey(name: r'visibleAfterAt', required: true, includeIfNull: true)
  final Object? visibleAfterAt;

  /// Thời điểm người dùng click chấp nhận
  @JsonKey(name: r'clickedAt', required: true, includeIfNull: true)
  final Object? clickedAt;

  /// Trạng thái chấp nhận AI
  @JsonKey(name: r'isAccepted', required: true, includeIfNull: false)
  final bool isAccepted;

  @override
  bool operator ==(Object other) =>
      identical(this, other) ||
      other is AIAcceptance &&
          other.id == id &&
  ...
  factory AIAcceptance.fromJson(Map<String, dynamic> json) =>
      _$AIAcceptanceFromJson(json);
