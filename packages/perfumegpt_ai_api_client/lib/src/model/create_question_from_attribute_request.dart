...
class CreateQuestionFromAttributeRequest {
  ...
  final List<String>? budgetRanges;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is CreateQuestionFromAttributeRequest &&
  ...
  factory CreateQuestionFromAttributeRequest.fromJson(Map<String, dynamic> json) => _$CreateQuestionFromAttributeRequestFromJson(json);

  Map<String, dynamic> toJson() => _$CreateQuestionFromAttributeRequestToJson(this);
