...
class SurveyGroupedAnswerItem {
  ...
  bool operator ==(Object other) =>
      ...
      other is SurveyGroupedAnswerItem &&
          other.detailId == detailId &&
          other.answerId == answerId &&
          other.answer == answer;

  @override
  int get hashCode => detailId.hashCode + answerId.hashCode + answer.hashCode;

  factory SurveyGroupedAnswerItem.fromJson(Map<String, dynamic> json) =>
      _$SurveyGroupedAnswerItemFromJson(json);
