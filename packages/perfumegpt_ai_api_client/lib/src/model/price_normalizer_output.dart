...
class PriceNormalizerOutput {
  ...
  PriceNormalizerOutput({this.min, this.max, this.operator_});
  ...
  bool operator ==(Object other) =>
      ...
      other is PriceNormalizerOutput &&
          other.min == min &&
          other.max == max &&
          other.operator_ == operator_;

  @override
  int get hashCode => min.hashCode + max.hashCode + operator_.hashCode;

  factory PriceNormalizerOutput.fromJson(Map<String, dynamic> json) =>
      _$PriceNormalizerOutputFromJson(json);
