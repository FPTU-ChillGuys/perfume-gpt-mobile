...
class OrderDetailListItem {
  ...
  final num? total;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is OrderDetailListItem &&
      other.id == id &&
  ...
  factory OrderDetailListItem.fromJson(Map<String, dynamic> json) => _$OrderDetailListItemFromJson(json);
