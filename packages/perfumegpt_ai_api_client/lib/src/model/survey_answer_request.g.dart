...
abstract class _$SurveyAnswerRequestCWProxy {
  ...
  SurveyAnswerRequest queryFragment(Object? queryFragment);
  ...
  /// ```
  SurveyAnswerRequest call({String answer, Object? queryFragment});
}
  ...
  SurveyAnswerRequest call({
    ...
    return SurveyAnswerRequest(
      answer: answer == const $CopyWithPlaceholder() || answer == null
          ...
          : answer as String,
      queryFragment: queryFragment == const $CopyWithPlaceholder()
          ? _value.queryFragment
          // ignore: cast_nullable_to_non_nullable
          : queryFragment as Object?,
    );
  }
}
...
SurveyAnswerRequest _$SurveyAnswerRequestFromJson(Map<String, dynamic> json) =>
    $checkedCreate('SurveyAnswerRequest', json, ($checkedConvert) {
      ...
      final val = SurveyAnswerRequest(
        ...
        queryFragment: $checkedConvert('queryFragment', (v) => v),
      );
      return val;
    });
...
Map<String, dynamic> _$SurveyAnswerRequestToJson(
  ...
  'queryFragment': ?instance.queryFragment,
};
