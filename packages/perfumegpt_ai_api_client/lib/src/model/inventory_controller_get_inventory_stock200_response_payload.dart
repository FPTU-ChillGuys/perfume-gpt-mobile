...
class InventoryControllerGetInventoryStock200ResponsePayload {
  ...
  final num totalPages;
    ...
    @override
    bool operator ==(Object other) => identical(this, other) || other is InventoryControllerGetInventoryStock200ResponsePayload &&
      other.items == items &&
  ...
  factory InventoryControllerGetInventoryStock200ResponsePayload.fromJson(Map<String, dynamic> json) => _$InventoryControllerGetInventoryStock200ResponsePayloadFromJson(json);

  Map<String, dynamic> toJson() => _$InventoryControllerGetInventoryStock200ResponsePayloadToJson(this);
