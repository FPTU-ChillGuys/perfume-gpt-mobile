...
class SurveysApi {
  ...
  surveyControllerCheckFirstTime({
    ...
    final _path = r'/surveys/user/{userId}/check-first-time'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  surveyControllerCreateQuestionFromAttribute({
    required CreateQuestionFromAttributeRequest
    createQuestionFromAttributeRequest,
    CancelToken? cancelToken,
    Map<String, dynamic>? headers,
    Map<String, dynamic>? extra,
  ...
  surveyControllerDeleteSurveyQuestion({
    ...
    final _path = r'/surveys/questions/{id}'.replaceAll(
      '{'
      r'id'
      '}',
      id.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerGetAllSurveys200Response>>
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerGetAttributeTypes200Response>>
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerGetAttributeValues200Response>>
  surveyControllerGetAttributeValues({
    ...
    final _path = r'/surveys/attributes/{type}/values'.replaceAll(
      '{'
      r'type'
      '}',
      type.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerGetMobileSurveyQuestions200Response>>
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerGetSurveyHistoryListByUserId200Response>>
  surveyControllerGetSurveyHistoryListByUserId({
    ...
    final _path = r'/surveys/user/{userId}/history'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerGetSurveyQuesAnwsByUserId200Response>>
  surveyControllerGetSurveyQuesAnwsByUserId({
    ...
    final _path = r'/surveys/user/{userId}'.replaceAll(
      '{'
      r'userId'
      '}',
      userId.toString(),
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerGetSurveyQuesById200Response>>
  ...
  /// Throws [DioException] if API call or serialization fails
  Future<Response<SurveyControllerSubmitMobileSurvey200Response>>
